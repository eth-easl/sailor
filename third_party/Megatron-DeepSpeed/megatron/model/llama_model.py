...
"""
Llama model.
Code from: https://github.com/ProjectD-AI/LLaMA-Megatron-DeepSpeed/blob/main/megatron/model/llama_model.py
"""
...
class LlamaEmbedding(MegatronModule):
    ...
    def __init__(self,
        ...
        self.word_embeddings = tensor_parallel.VocabParallelEmbedding(vocab_size, self.hidden_size, config=config,
                                                          init_method=self.init_method)
...
class LlamaParallelMLP(MegatronModule):
    ...
    def __init__(self, init_method, config, output_layer_init_method, moe=False, enable_expert_tensor_parallelism=False):
    ...
    def forward(self, hidden_states):
        ...
        # TODO: note that the HF is a bit different:
...
class LlamaParallelTransformerLayer(MegatronModule):
    ...
    def __init__(self, init_method, config, output_layer_init_method,
        ...
        # MLP
        self.mlp = LlamaParallelMLP(self.init_method, config, self.output_layer_init_method)
